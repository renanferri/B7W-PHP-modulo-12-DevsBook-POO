...
// $feeds = $postDao->getHomeFeed($userInfo->id);
        ...
        <div class="column pl-5">
            ...
            <div class="box">
                <div class="box-header m-10">
                    ...
                    <div class="box-header-buttons">
                        <a href="<?=$base;?>/fotos.php?id=<?=$item->id;?>">ver todos</a>
                    </div>
                </div>
            ...
            <?php if (count($feeds) > 0): ?>
                ...
                <?php for($q=0;$q<$pages;$q++): ?>
                    <a class="<?=($currentPage==$q+1)?'active':''?>" href="<?=$base;?>/perfil.php?id=<?=$id;?>&p=<?=$q+1;?>"><?=$q+1;?></a>
                <?php endfor; ?>
